...
<?php $cta_subtitle = get_field('cta_subtitle'); ?>
<?php $cta_link_text = get_field('cta_link_text'); ?>
<?php $cta_link_url = get_field('cta_link_url'); ?>
<?php $background_color = get_field('gradient_color'); ?>
<?php $cta_link_icon = get_field('cta_link_icon'); ?>

<div style="height: 160px;" class="spacer"></div>
<div class="section section-cta-footer text-center">
...
<?php  // end if is not contact page ?>
